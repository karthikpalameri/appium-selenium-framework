...
//		t.tap(TapOptions.tapOptions().withElement(ElementOption.element(ele)).withPosition(positionOption)
		...
		MobileElement customAdapter = driver
				.findElementByXPath("//android.widget.TextView[@content-desc=\"1. Custom Adapter\"]");
		...
		t.longPress(LongPressOptions.longPressOptions().withElement(ElementOption.element(peopleNames))
				.withDuration(Duration.ofMillis(15000))).release().perform();
